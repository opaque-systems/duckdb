...
public:
	inline static constexpr LogicalTypeId SQLNULL = LogicalTypeId::SQLNULL;
	inline static constexpr LogicalTypeId BOOLEAN = LogicalTypeId::BOOLEAN;
	inline static constexpr LogicalTypeId TINYINT = LogicalTypeId::TINYINT;
	inline static constexpr LogicalTypeId UTINYINT = LogicalTypeId::UTINYINT;
	inline static constexpr LogicalTypeId SMALLINT = LogicalTypeId::SMALLINT;
	inline static constexpr LogicalTypeId USMALLINT = LogicalTypeId::USMALLINT;
	inline static constexpr LogicalTypeId INTEGER = LogicalTypeId::INTEGER;
	inline static constexpr LogicalTypeId UINTEGER = LogicalTypeId::UINTEGER;
	inline static constexpr LogicalTypeId BIGINT = LogicalTypeId::BIGINT;
	inline static constexpr LogicalTypeId UBIGINT = LogicalTypeId::UBIGINT;
	inline static constexpr LogicalTypeId FLOAT = LogicalTypeId::FLOAT;
	inline static constexpr LogicalTypeId DOUBLE = LogicalTypeId::DOUBLE;
	inline static constexpr LogicalTypeId DATE = LogicalTypeId::DATE;
	inline static constexpr LogicalTypeId TIMESTAMP = LogicalTypeId::TIMESTAMP;
	inline static constexpr LogicalTypeId TIMESTAMP_S = LogicalTypeId::TIMESTAMP_SEC;
	inline static constexpr LogicalTypeId TIMESTAMP_MS = LogicalTypeId::TIMESTAMP_MS;
	inline static constexpr LogicalTypeId TIMESTAMP_NS = LogicalTypeId::TIMESTAMP_NS;
	inline static constexpr LogicalTypeId TIME = LogicalTypeId::TIME;
	inline static constexpr LogicalTypeId TIMESTAMP_TZ = LogicalTypeId::TIMESTAMP_TZ;
	inline static constexpr LogicalTypeId TIME_TZ = LogicalTypeId::TIME_TZ;
	inline static constexpr LogicalTypeId VARCHAR = LogicalTypeId::VARCHAR;
	inline static constexpr LogicalTypeId ANY = LogicalTypeId::ANY;
	inline static constexpr LogicalTypeId BLOB = LogicalTypeId::BLOB;
	inline static constexpr LogicalTypeId INTERVAL = LogicalTypeId::INTERVAL;
	inline static constexpr LogicalTypeId HUGEINT = LogicalTypeId::HUGEINT;
	inline static constexpr LogicalTypeId UUID = LogicalTypeId::UUID;
	inline static constexpr LogicalTypeId HASH = LogicalTypeId::HASH;
	inline static constexpr LogicalTypeId POINTER = LogicalTypeId::POINTER;
	inline static constexpr LogicalTypeId TABLE = LogicalTypeId::TABLE;
	inline static constexpr LogicalTypeId INVALID = LogicalTypeId::INVALID;
	inline static constexpr LogicalTypeId JSON = LogicalTypeId::JSON;
	inline static constexpr LogicalTypeId ROW_TYPE = LogicalTypeId::BIGINT;
